...
VALUES  
    ('01', 'instructor1', '123456789', N'Nguyễn Hoài An', 'male', '1990-12-18', 'Bio', 'Economics', 'ins1@gmail.com'),
    ('02', 'instructor2', '123456789', N'Trần Trà Hương', 'female', '1986-10-12', 'Bio', 'Biology', 'ins2@gmail.com') ,
    ('03', 'instructor3', '123456789', N'Nguyễn Ngọc Ánh', 'female', '1990-10-12', 'Bio', 'Biology', 'ins3@gmail.com'), 
    ('04', 'instructor4', '123456789', N'Trương Nam Sơn', 'male', '1994-10-12', 'Bio', 'Biology', 'ins4@gmail.com'),
    ('05', 'instructor5', '123456789', N'Lý Hoàng Hà', 'other', '1990-10-12', 'Bio', 'Biology', 'ins5@gmail.com'),
    ('06', 'instructor6', '123456789', N'Trần Bạch Tuyết', 'female', '1990-10-12', 'Bio', 'Biology', 'ins6@gmail.com'), 
    ('07', 'instructor7', '123456789', N'Nguyễn An Trung', 'male', '1990-10-12', 'Bio', 'Chemistry', 'ins7@gmail.com'), 
    ('08', 'instructor8', '123456789', N'Trần Trung Hiếu', 'male', '1990-10-12', 'Bio', 'Foreign Language', 'ins8@gmail.com') 
GO
